  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form role="form" enctype="multipart/form-data" name="crear-registro-miembro-prueba" id="crear-registro-miembro-prueba" method="post" action="modelo-prueba.php">
          
          <?php include("../templates/datos-miembro-prueba.php") ?>          
